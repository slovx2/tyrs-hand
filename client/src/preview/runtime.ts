...
export function listPreviewSSHProjects(profileId: string): SSHProject[] {
  return control(profileId).projects.map((project) => ({ profileId, id: project.id,
    remotePath: project.cwd }));
}
