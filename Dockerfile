...
FROM node:24.14.0-bookworm-slim@sha256:d8e448a56fc63242f70026718378bd4b00f8c82e78d20eefb199224a4d8e33d8 AS codex-cli
...
RUN install -d -o tyrs-hand -g tyrs-hand -m 0700 \
    /data/control/attachments /data/control/codex-homes
COPY --from=codex-cli --chown=root:root /out/codex /usr/local/bin/codex
