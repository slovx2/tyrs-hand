...
export function DevelopmentProjectForums({
  project,
  ownerDiscordUserId,
  members,
}: {
  ...
  const pair = useMutation({
    mutationFn: (input: { mode: 'new' | 'restore'; forumId?: string }) =>
      api<void>(`/development-projects/${project.id}/forums`, {
        method: 'POST',
  ...
  const disable = useMutation({
    mutationFn: (forumId: string) =>
      api<void>(`/development-forums/${forumId}/disable`, { method: 'POST' }),
    onSuccess: async () => {
...
function ForumCollaborators({
  ...
  const save = useMutation({
    mutationFn: () =>
      api<void>(
        `/development-projects/${projectId}/forums/${forum.id}/collaborators/${memberId}`,
        {
          method: 'PUT',
  ...
  const remove = useMutation({
    mutationFn: (targetMemberId: string) =>
      api<void>(
        `/development-projects/${projectId}/forums/${forum.id}/collaborators/${targetMemberId}`,
        { method: 'DELETE' },
      ),
    onSuccess: async () => {
