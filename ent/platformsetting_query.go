...
func (_q *PlatformSettingQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *PlatformSettingQuery) FirstIDX(ctx context.Context) int {
...
func (_q *PlatformSettingQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *PlatformSettingQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *PlatformSettingQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *PlatformSettingQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(platformsetting.FieldSettingKey).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.PlatformSetting.Query().
//		Select(platformsetting.FieldSettingKey).
//		Scan(ctx, &v)
...
func (_q *PlatformSettingQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(platformsetting.Table, platformsetting.Columns, sqlgraph.NewFieldSpec(platformsetting.FieldID, field.TypeInt))
	_spec.From = _q.sql
