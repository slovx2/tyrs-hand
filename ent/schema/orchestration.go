...
func (CodexThreadControl) Fields() []ent.Field {
	return []ent.Field{
		...
		field.UUID("worker_id", uuid.UUID{}).Optional().Nillable(),
		field.String("external_thread_id").Optional().Nillable(), field.String("status").Default("idle"),
		field.String("collaboration_mode").Default("default"),
		field.Int64("collaboration_mode_revision").Default(0),
		...
		field.String("lease_owner").Optional().Nillable(), field.String("lease_token").Optional().Nillable().Sensitive(),
...
func (CodexTurnRun) Fields() []ent.Field {
	return []ent.Field{
		field.UUID("id", uuid.UUID{}).Default(uuid.New), field.UUID("control_id", uuid.UUID{}),
		field.UUID("primary_intent_id", uuid.UUID{}), field.Int("attempt"), field.String("lease_owner"),
