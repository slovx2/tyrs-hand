...
func (_u *AuditLogUpdate) SetAdministratorID(v uuid.UUID) *AuditLogUpdate {
	_u.mutation.SetAdministratorID(v)
	return _u
}

// SetNillableAdministratorID sets the "administrator_id" field if the given value is not nil.
func (_u *AuditLogUpdate) SetNillableAdministratorID(v *uuid.UUID) *AuditLogUpdate {
	if v != nil {
		_u.SetAdministratorID(*v)
	}
	return _u
}

// ClearAdministratorID clears the value of the "administrator_id" field.
func (_u *AuditLogUpdate) ClearAdministratorID() *AuditLogUpdate {
	_u.mutation.ClearAdministratorID()
	return _u
}
...
func (_u *AuditLogUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AdministratorID(); ok {
		_spec.SetField(auditlog.FieldAdministratorID, field.TypeUUID, value)
	}
	if _u.mutation.AdministratorIDCleared() {
		_spec.ClearField(auditlog.FieldAdministratorID, field.TypeUUID)
	}
...
// SetAdministratorID sets the "administrator_id" field.
func (_u *AuditLogUpdateOne) SetAdministratorID(v uuid.UUID) *AuditLogUpdateOne {
	_u.mutation.SetAdministratorID(v)
	return _u
}

// SetNillableAdministratorID sets the "administrator_id" field if the given value is not nil.
func (_u *AuditLogUpdateOne) SetNillableAdministratorID(v *uuid.UUID) *AuditLogUpdateOne {
	if v != nil {
		_u.SetAdministratorID(*v)
	}
	return _u
...
// ClearAdministratorID clears the value of the "administrator_id" field.
func (_u *AuditLogUpdateOne) ClearAdministratorID() *AuditLogUpdateOne {
	_u.mutation.ClearAdministratorID()
	return _u
}
