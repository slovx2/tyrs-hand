...
func TestWebhookRouterSeparation(t *testing.T) {
	...
	require.Contains(t, combined, "POST /api/v1/client/tunnels")
	require.Contains(t, combined, "POST /api/v1/client/materializations")
	require.Contains(t, combined, "GET /api/v1/client/legacy/archive/sessions")
	require.NotContains(t, combined, "GET /api/v1/client/sessions")
	require.NotContains(t, combined, "GET /api/v1/client/updates")
