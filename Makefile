...
.PHONY: test-protocol-matrix test-runtime-e2e test-control-runtime test-control-runtime-e2e
...
client-e2e-contract:
	...
	node --test tools/mobile-e2e/lib/*.test.mjs tools/mobile-e2e/verify-evidence.test.mjs tools/mobile-e2e/build-client.test.mjs
