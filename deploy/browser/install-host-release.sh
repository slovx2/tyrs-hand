...
TYRS_BROWSER_PROXY_PORT=8932
TYRS_BROWSER_INTERNAL_MCP_PORT=8933
TYRS_BROWSER_AGENT_HOST=0.0.0.0
TYRS_BROWSER_AGENT_PORT=8934
...
echo "5. 先在 Codex 中调用 Worker 浏览器打开网页，再检查 http://127.0.0.1:8931/health 的 status=ready、connected=true 和扩展版本。"
